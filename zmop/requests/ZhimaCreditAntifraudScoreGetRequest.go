...
type ZhimaCreditAntifraudScoreGetRequest struct {
...
func (m *ZhimaCreditAntifraudScoreGetRequest) InitBizParams(address, bankCard, certNo, certType, email, imei, ip, mac, mobile, name, productCode, transactionId, wifimac string) {
...
func (*ZhimaCreditAntifraudScoreGetRequest) GetApiMethodName() string {
	return "zhima.credit.antifraud.score.get"
}

func (m *ZhimaCreditAntifraudScoreGetRequest) GetApiParams() *map[string]string {
	return m.ApiParams
}

func (m *ZhimaCreditAntifraudScoreGetRequest) GetFileParams() *map[string]string {
	return m.FileParams
}

func (m *ZhimaCreditAntifraudScoreGetRequest) SetApiVersion(ApiVersion string) {
	m.ApiVersion = ApiVersion
}

func (m *ZhimaCreditAntifraudScoreGetRequest) GetApiVersion() string {
	return m.ApiVersion
}

func (m *ZhimaCreditAntifraudScoreGetRequest) SetScene(Scene string) {
	m.Scene = Scene
}

func (m *ZhimaCreditAntifraudScoreGetRequest) GetScene() string {
	return m.Scene
}

func (m *ZhimaCreditAntifraudScoreGetRequest) SetChannel(Channel string) {
	m.Channel = Channel
}

func (m *ZhimaCreditAntifraudScoreGetRequest) GetChannel() string {
	return m.Channel
}

func (m *ZhimaCreditAntifraudScoreGetRequest) SetPlatform(Platform string) {
	m.Platform = Platform
}

func (m *ZhimaCreditAntifraudScoreGetRequest) GetPlatform() string {
	return m.Platform
}

func (m *ZhimaCreditAntifraudScoreGetRequest) SetExtParams(ExtParams string) {
	m.ExtParams = ExtParams
}

func (m *ZhimaCreditAntifraudScoreGetRequest) GetExtParams() string {
	return m.ExtParams
}
