...
type ZhimaCreditAntifraudVerifyRequest struct {
	...
	certType      string // 证件类型。证件类型、证件号、姓名三要素均为必填参数
...
func (m *ZhimaCreditAntifraudVerifyRequest) InitBizParams(address, bankCard, certNo, certType, email, imei, ip, mac, mobile, name, productCode, transactionId, wifimac string) {
...
func (*ZhimaCreditAntifraudVerifyRequest) GetApiMethodName() string {
	return "zhima.credit.antifraud.verify"
}

func (m *ZhimaCreditAntifraudVerifyRequest) GetApiParams() *map[string]string {
	return m.ApiParams
}

func (m *ZhimaCreditAntifraudVerifyRequest) GetFileParams() *map[string]string {
	return m.FileParams
}

func (m *ZhimaCreditAntifraudVerifyRequest) SetApiVersion(ApiVersion string) {
	m.ApiVersion = ApiVersion
}

func (m *ZhimaCreditAntifraudVerifyRequest) GetApiVersion() string {
	return m.ApiVersion
}

func (m *ZhimaCreditAntifraudVerifyRequest) SetScene(Scene string) {
	m.Scene = Scene
}

func (m *ZhimaCreditAntifraudVerifyRequest) GetScene() string {
	return m.Scene
}

func (m *ZhimaCreditAntifraudVerifyRequest) SetChannel(Channel string) {
	m.Channel = Channel
}

func (m *ZhimaCreditAntifraudVerifyRequest) GetChannel() string {
	return m.Channel
}

func (m *ZhimaCreditAntifraudVerifyRequest) SetPlatform(Platform string) {
	m.Platform = Platform
}

func (m *ZhimaCreditAntifraudVerifyRequest) GetPlatform() string {
	return m.Platform
}

func (m *ZhimaCreditAntifraudVerifyRequest) SetExtParams(ExtParams string) {
	m.ExtParams = ExtParams
}

func (m *ZhimaCreditAntifraudVerifyRequest) GetExtParams() string {
	return m.ExtParams
}
